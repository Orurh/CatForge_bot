...
func BuildPrompt(request GenerationRequest) Prompt {
	...
	if request.HumorMode == HumorBold {
		system += " Bold — дерзкий взрослый юмор на грани 18+: едкий сарказм, чёрный юмор, наглые подколы и двусмысленные намёки без описаний секса. Не смягчай панчлайн доброй моралью, извинением или заботливым завершением. Отвечай на конкретные слова собеседника, а не случайной заготовкой. Мат разрешён как выразительный акцент, но только запиканный символами: «бл***», «ох***ть», «на х***», «п***ец». Никогда не пиши матерное слово целиком; не вставляй ругань в каждую фразу. Характер определяет манеру дерзить, а не снижает остроту: ленивый — сухо и нехотя, задира — нагло, философ — с мрачным пафосом, чистюля — брезгливо, соня — раздражённо спросонья. Подкалывай высказывание или ситуацию; без травли, угроз реальным людям и оскорблений по признакам личности."
	} else {
		system += " Normal — ирония и острые подколы без мата, запиканной ругани и сексуальных намёков."
	}
